...
namespace MoviesApi.Services
{
    public class InAppStorageService : IFileStorageService
    {
        ...
        public async Task<string> SaveFile(byte[] content, string extension, string continerName, string contentType)
        {
            ...
            var pathForDatabase = Path.Combine(currentUrl, continerName, fileName);
